...
@BianRestController
public class CorporateLoanApiController {

	@Autowired
	CorporateLoanApiService service;
	
	@Fulfill.Activate
	public BianResponse<SDCorporateLoanActivateOutputModel> activate(@RequestBody BianRequest<SDCorporateLoanActivateInputModel> bianRequest) {
		return BianResponse.forSuccess(service.activate(bianRequest.getData()));
	}
	
	@Fulfill.Configure
	public BianResponse<SDCorporateLoanConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateLoanConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Control
	public BianResponse<CRCorporateLoanFulfillmentArrangementControlOutputModel> control(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateLoanFulfillmentArrangementControlInputModel> bianRequest) {
	...
	@Fulfill.Feedback
	public BianResponse<SDCorporateLoanFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateLoanFeedbackInputModel> bianRequest) {
		return BianResponse.forSuccess(service.feedback(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Initiate
	public BianResponse<CRCorporateLoanFulfillmentArrangementInitiateOutputModel> initiate(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRCorporateLoanFulfillmentArrangementInitiateInputModel> bianRequest) {
	...
	@Fulfill.Retrieve
	public BianResponse<CRCorporateLoanFulfillmentArrangementRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@Fulfill.RetrieveSD
	public BianResponse<SDCorporateLoanRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
		return BianResponse.forSuccess(service.retrieveSD(sdReferenceId));
	}
	
	@Fulfill.Update
	public BianResponse<CRCorporateLoanFulfillmentArrangementUpdateOutputModel> update(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateLoanFulfillmentArrangementUpdateInputModel> bianRequest) {
